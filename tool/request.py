...
try:
    response = requests.get('http://localhost:8080/request/u51/cmd:authorize;33D65AF3FB7E97A8DBF6D443')#('http://117.78.33.205:18080/request/u51/cmd:authorize;1QZ7PUNTXJIL6VA9K58DMYS2')
except:
    print "response u51 raise error"
else:
    print 'status u51 code:',response.status_code
